...
int main(void) {
    ...
    // ================================================================
    // 1. Initialize system clocks and configuration
    // ================================================================
    SystemInit();  // Initialize system clocks, PLL, flash settings, etc.
    
    // ================================================================
    // 2. Initialize LEDs using high-level API
    // ================================================================
    led_init();
    
    // ================================================================
    // 3. Main loop - RGB color cycling using GPIO API functions
    // ================================================================
